...
class Sorter {
  ...
  public:
      ...
      void bubbleSortI();     
      void insertionSortR();
      void selectionHelper1(unsigned int); 
      void  selectionHelper2(unsigned int, unsigned int& );
      void selectionSortR();	
      void bubbleSortR();
      void bubbleHelper1(unsigned int); 
      void bubbleHelper2(unsigned int);
      void insertionHelper1(unsigned int);	
      void insertionHelper2(unsigned int);
};
